...
public class GeneradorCodidoG {
	...
	public static double MaxVelAvanceMaquina = 8; //para colocar en el archivo de configuracion - Maxima velocidad de Avance de la Maquina en todos los ejes (Valor normal 800)
	public static double MaxVelcorteTool = 2; //para colocar en el archivo de configuracion - Maxima velocidad de Avance de corte de la maquina (Valor normal 150)
	...
	public void GenCodG(){
		...
		if(br.UNB.LAB.Integrador.Integrador.ImpLedFer==1){
			...
			ImprimirSecuenciaLineaNo.EscribirLinea("G17 G54 G40 G90");
		}
