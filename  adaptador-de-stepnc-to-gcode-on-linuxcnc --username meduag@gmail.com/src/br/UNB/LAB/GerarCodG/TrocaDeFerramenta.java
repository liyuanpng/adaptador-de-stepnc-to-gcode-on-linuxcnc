		...
		public static void ImpriFer(String data) {
				...
				if(Integrador.ImpG55==1){
					if(br.UNB.LAB.Integrador.Integrador.ImpLedFer==1){
						ImprimirSecuenciaLineaNo.EscribirLinea("G90 G40 G55 G00 Z" + GeneradorCodidoG.df.format(GeneradorCodidoG.ZM06));
					}else{
						ImprimirSecuenciaLineaNo.EscribirLinea("G90 G40 G00 Z" + GeneradorCodidoG.df.format(GeneradorCodidoG.ZM06));
					}
					ImprimirSecuenciaLineaNo.EscribirLinea("G01 F" + GeneradorCodidoG.df.format(GeneradorCodidoG.MaxVelAvanceMaquina) +" X"+GeneradorCodidoG.df.format(0) + " Y"+ GeneradorCodidoG.df.format(0));
...
//						System.out.println(valoresData);
			...
			if(Integrador.ImpG55==1){
				ImprimirSecuenciaLineaNo.EscribirLinea("G00 Z" + GeneradorCodidoG.df.format(GeneradorCodidoG.ZM06));
